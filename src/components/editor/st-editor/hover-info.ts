...
const keywordInfo: Record<string, HoverData> = {
  ...
  premise:     { title: 'premise', description: 'Alias de compatibilidad para introducir una premisa temporal sin salir del estilo de deducción natural usado en clase.', example: 'premise h1 : p -> q', category: 'keyword' },
  premisa:     { title: 'premisa (→ premise)', description: 'Alias en español para premise.', example: 'premisa h1 : p -> q', category: 'alias' },
  ...
  conclusion:  { title: 'conclusion', description: 'Atajo compatible con ejercicios de clase. Cierra una secuencia de premise/premisa y fija la meta final.', example: 'conclusion q', category: 'keyword' },
  therefore:   { title: 'therefore', description: 'Atajo tipo sequent/pizarra para indicar la conclusión de una inferencia.', example: 'therefore q', category: 'keyword' },
  por_tanto:   { title: 'por_tanto (→ therefore)', description: 'Alias en español para cerrar una inferencia tipo clase.', example: 'por_tanto q', category: 'alias' },
...
const operatorInfo: Record<string, HoverData> = {
  ...
  '↔':   { title: '↔  Bicondicional', description: 'Versión Unicode de <->.', example: 'p ↔ q', category: 'operator' },
  '&':   { title: '∧  Conjunción', description: 'A y B. Verdadero solo cuando ambos son verdaderos.', example: 'p & q', category: 'operator' },
  '∧':   { title: '∧  Conjunción', description: 'Versión Unicode de &.', example: 'p ∧ q', category: 'operator' },
  '|':   { title: '∨  Disyunción', description: 'A o B. Falso solo cuando ambos son falsos.', example: 'p | q', category: 'operator' },
  '∨':   { title: '∨  Disyunción', description: 'Versión Unicode de |.', example: 'p ∨ q', category: 'operator' },
  ...
  '¬':   { title: '¬  Negación', description: 'Versión Unicode de ! y ~.', example: '¬p', category: 'operator' },
  ...
  '|-':  { title: '⊢  Turnstile ASCII', description: 'Separa premisas y conclusión en estilo de secuente. La compatibilidad lo traduce a una prueba ST.', example: '{p -> q, p} |- q', category: 'operator' },
  '⊢':   { title: '⊢  Turnstile', description: 'Versión Unicode del secuente. La compatibilidad la traduce a ST canónico.', example: '{p -> q, p} ⊢ q', category: 'operator' },
  '⊥':   { title: '⊥  Contradicción', description: 'Constante de falsedad/absurdo en notación clásica. La compatibilidad la expande a una contradicción canónica.', example: 'p -> ⊥', category: 'operator' },
  '⊤':   { title: '⊤  Verdad', description: 'Constante de verdad. La compatibilidad la expande a una tautología canónica.', example: 'p & ⊤', category: 'operator' },
